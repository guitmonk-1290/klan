...
async function Page({ params }: { params: { id: string } }) {
    ...
    return (
        <div className={`${pathname?.length!>8 ? 'w-full h-full' : 'w-full h-full max-sm:hidden max-md:hidden md:visible xl:visible'}`}>
            <section>
                <div className="flex-1 justify-between flex flex-col h-full max-h-[calc(100vh-6rem)] w-full">
                    <div className="bg-dark-2 text-light-1 flex sm:items-center justify-between py-3 border-b-1 px-2">
